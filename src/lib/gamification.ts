...
export function computeChallenges(totals: RiderTotals, sessions: RideSession[]): Challenge[] {
  ...
  const challenges: Challenge[] = [
    ...
    { id: "daily-20min", type: "daily", title: "Ride 20 Minutes in One Session", current: Math.min(Math.round(bestTodayMinutes), 20), goal: 20, reward: 5, completed: bestTodayMinutes >= 20, repeatable: true },
    ...
    { id: "weekly-60min", type: "weekly", title: "Ride 60 Total Minutes This Week", current: Math.min(Math.round(weekMinutes), 60), goal: 60, reward: 15, completed: weekMinutes >= 60, repeatable: true },
